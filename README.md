...
<p>
  ...
  <img alt="Workflow" src="https://github.
com/Kereot/foodgram/actions/workflows/main.yml/badge.svg?branch=main" />
</p>
...
порядке приготовления, изображении готового люда. Все пользователи могут также 
...
Проектом рекомендовано использовать порт :10000.<br> 
